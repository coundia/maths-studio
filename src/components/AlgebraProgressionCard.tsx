...
export const AlgebraProgressionCard: React.FC<AlgebraProgressionCardProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-slate-900/95 border border-slate-800 rounded-2xl p-4 lg:p-6 shadow-xl backdrop-blur-xl">
      {/* Title */}
            ...
            <div
              ...
              className={`p-3.5 rounded-xl cursor-pointer transition-all border ${
                isActive
                  ...
                  : 'bg-slate-950/40 border-slate-800/40 hover:border-slate-800 opacity-60'
              }`}
            >
              ...
              {/* KaTeX formula line */}
              <div
                className={`py-2 px-3 rounded-lg overflow-x-auto text-base sm:text-lg transition-colors ${
                  isActive
                    ? 'bg-slate-950 text-white border border-indigo-500/40'
              ...
              {isActive && (
                <div className="mt-2.5 pt-2 border-t border-indigo-500/20 text-xs text-indigo-200/90 leading-relaxed flex items-start space-x-1.5">
