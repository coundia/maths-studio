...
export const FACTORIZATION_PRESETS: FactorizationProblem[] = [
  {
    ...
    term2Remaining: '5',
    operator: '+',
    groupedBracketLatex: '5 \\cdot [3x + 5]',
  ...
  },
  {
    ...
    term2Remaining: '4',
    operator: '-',
    groupedBracketLatex: '2x \\cdot [3x - 4]',
  ...
  },
  {
    ...
    term2Remaining: '3',
    operator: '+',
    groupedBracketLatex: '6 \\cdot [2x + 3]',
  ...
  },
  {
    ...
    term2Remaining: '(x + 5)',
    operator: '+',
    groupedBracketLatex: '(x + 2) \\cdot [(3x - 1) + (x + 5)]',
  ...
  },
  {
    ...
    term2Remaining: '(5x - 2)',
    operator: '-',
    groupedBracketLatex: '(2x - 3) \\cdot [(x + 4) - (5x - 2)]',
