    ...
    <div className="w-full flex flex-col space-y-4">
          ...
          <div className="relative w-full aspect-video rounded-2xl overflow-hidden bg-slate-950 border border-slate-800 shadow-2xl">
            {videoInfo?.embedUrl ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center p-6 text-center text-slate-400">
                ...
                <p className="font-semibold text-white">Module Vidéo Pédagogique 3e</p>
      ...
      {activeTab === 'summary' && (
        <div className="flex flex-col space-y-3">
          <div className="p-3.5 rounded-xl bg-emerald-950/30 border border-emerald-500/30 text-xs sm:text-sm text-emerald-200">
            <span className="font-bold text-white">Règle essentielle : </span>
            {ruleSummary}
          </div>
          ...
          <div className="space-y-3">
            {steps.map((st) => (
              ...
              >
                ...
                <div className="p-2 rounded-lg bg-slate-900 text-emerald-300 font-mono text-xs overflow-x-auto">
