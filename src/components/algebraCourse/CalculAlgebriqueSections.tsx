    ...
    <div className="flex flex-col space-y-5">
              ...
              <table className="w-full text-xs text-left text-neutral-800 dark:text-slate-300 border border-neutral-200 dark:border-slate-800">
                ...
                <tbody className="divide-y divide-neutral-200 dark:divide-slate-800/60 font-mono text-[11px]">
                  <tr>
                    ...
                    <td className="p-2.5 text-emerald-700 dark:text-emerald-300">-7x², 4x, 15, 3ab</td>
                  </tr>
                  <tr>
      ...
      {activeSection === 2 && (
        <div className="flex flex-col space-y-5 animate-fade-in">
          ...
          <div className="bg-rose-50 border border-rose-300 text-rose-950 dark:bg-rose-950/30 dark:border-rose-500/50 dark:text-rose-200 p-4 sm:p-5 rounded-2xl space-y-3 shadow-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
              {/* Cas 1 in BLEU */}
              <div className="p-3.5 rounded-xl bg-sky-50 border border-sky-300 text-sky-950 dark:bg-slate-950 dark:border-slate-800 space-y-2 shadow-xs">
              ...
              {/* Cas 2 in ROSE */}
              <div className="p-3.5 rounded-xl bg-rose-100/70 border border-rose-300 text-rose-950 dark:bg-slate-950 dark:border-rose-800/60 space-y-2 shadow-xs">
          ...
          <div className="bg-sky-50/90 border border-sky-300 text-sky-950 dark:bg-slate-950/80 dark:border-sky-500/40 dark:text-slate-300 p-4 sm:p-5 rounded-2xl space-y-4 shadow-xs">
            ...
            <div className="p-3.5 bg-white dark:bg-slate-900/90 rounded-xl border border-sky-200 dark:border-slate-800 space-y-3 shadow-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                {/* Exemple A in VERT */}
                <div className="p-3 bg-emerald-50 border border-emerald-300 text-emerald-950 dark:bg-slate-950 dark:border-slate-800 rounded-lg space-y-1.5 font-mono shadow-xs">
                ...
                {/* Exemple B in BLEU */}
                <div className="p-3 bg-sky-50 border border-sky-300 text-sky-950 dark:bg-slate-950 dark:border-slate-800 rounded-lg space-y-1.5 font-mono shadow-xs">
                      ...
                      <button
                        ...
                        className={`px-2 py-1 rounded text-xs font-mono font-bold transition-all ${
                          powerBase === b
                            ...
                            : 'bg-neutral-100 text-neutral-800 hover:bg-neutral-200 border border-neutral-300 dark:bg-slate-950 dark:text-slate-300 dark:border-slate-800'
                        }`}
                      >
                        {b}
                      </button>
        ...
        <div className="flex flex-col space-y-5 animate-fade-in">
          ...
          <div className="bg-emerald-50/90 border border-emerald-300 text-emerald-950 dark:bg-slate-950/80 dark:border-amber-500/40 dark:text-slate-300 p-4 sm:p-5 rounded-2xl space-y-4 shadow-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5 text-xs font-mono">
              {/* Cas 1 in VERT */}
              <div className="p-3 rounded-xl bg-emerald-100/70 border border-emerald-300 text-center space-y-1 shadow-xs">
              ...
              {/* Cas 2 in BLEU */}
              <div className="p-3 rounded-xl bg-sky-100/70 border border-sky-300 text-center space-y-1 shadow-xs">
              ...
              <div className="p-3 rounded-xl bg-emerald-200/80 border-2 border-emerald-600 text-center space-y-1 shadow-xs">
      ...
      {activeSection === 4 && (
        <div className="flex flex-col space-y-5 animate-fade-in">
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-slate-800 space-y-3">
            <h4 className="font-bold text-sky-400 text-xs sm:text-sm uppercase tracking-wide">
              1. Qu'est-ce que réduire une expression ?
            </h4>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              <strong className="text-white">Réduire</strong> une expression littérale, c'est l'écrire avec le minimum de termes possibles en regroupant les <strong className="text-emerald-400">termes semblables</strong> (termes ayant la même variable affectée du même exposant).
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 text-xs">
              <div className="p-3 rounded-xl bg-purple-950/40 border border-purple-500/30 text-purple-200 text-center">
                <span className="font-bold block text-white mb-0.5">Famille des x³</span>
                <MathView latex="2x^3, -5x^3" display={false} />
              </div>
              <div className="p-3 rounded-xl bg-sky-950/40 border border-sky-500/30 text-sky-200 text-center">
                <span className="font-bold block text-white mb-0.5">Famille des x²</span>
                <MathView latex="3x^2, -7x^2, x^2" display={false} />
              </div>
              <div className="p-3 rounded-xl bg-emerald-950/40 border border-emerald-500/30 text-emerald-200 text-center">
                <span className="font-bold block text-white mb-0.5">Famille des x</span>
                <MathView latex="5x, -2x, -x" display={false} />
              </div>
              <div className="p-3 rounded-xl bg-amber-950/40 border border-amber-500/30 text-amber-200 text-center">
                <span className="font-bold block text-white mb-0.5">Constantes</span>
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-slate-800 space-y-3">
            <h4 className="font-bold text-emerald-400 text-xs sm:text-sm uppercase tracking-wide">
              2. Règle d'addition : Additionner les coefficients et conserver la lettre
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 font-mono text-xs text-emerald-300">
            ...
            <div className="p-3.5 bg-rose-950/30 border border-rose-500/40 rounded-xl text-xs text-rose-200">
              <strong className="text-white block font-bold mb-0.5">Interdiction absolue :</strong>
              On ne peut JAMAIS additionner des termes de familles différentes !
              <br />
              <MathView latex="3x + 2x^2" display={false} /> ne donne PAS <span className="line-through text-rose-400 font-mono">5x³</span> ! L'expression est déjà irréductible. De même, <MathView latex="5x + 4 \neq 9x" display={false} />.
            </div>
          </div>
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-slate-800 space-y-3">
            ...
            <p className="text-xs text-slate-300">
              Au Sénégal, les inspecteurs et correcteurs du BFEM exigent que le résultat final soit ordonné dans le sens : <strong className="text-emerald-400">Degré 2 &gt; Degré 1 &gt; Constante</strong> :
            </p>

            <div className="p-4 bg-slate-900 rounded-xl border border-slate-800 text-xs space-y-1.5 font-mono text-emerald-300">
              <div><MathView latex="P = 7x - 5x^2 + 4 + 2x^2 - 3x - 9" display={false} /></div>
              <div className="text-slate-400 text-[11px]">Regroupement par familles :</div>
              <div><MathView latex="P = (-5x^2 + 2x^2) + (7x - 3x) + (4 - 9)" display={false} /></div>
              <div className="text-white font-bold text-sm"><MathView latex="P = -3x^2 + 4x - 5" display={false} /> (Forme ordonnée et réduite)</div>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="flex flex-col space-y-5 animate-fade-in">
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-slate-800 space-y-3">
            ...
            <div className="space-y-1.5 text-xs font-mono text-slate-300 pt-1">
              ...
              <div className="text-amber-300">Exemple facteur négatif : <MathView latex="-4x(3x - 2) = (-4x) \times (3x) - (-4x) \times 2 = -12x^2 + 8x" display={false} /></div>
            </div>
          </div>

          {/* 2. Double distributivité (Les 4 flèches) */}
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-indigo-500/30 space-y-3">
            <h4 className="font-bold text-indigo-300 text-xs sm:text-sm uppercase tracking-wide flex items-center justify-between">
            ...
            <div className="p-3 bg-slate-900 rounded-xl text-center text-sm font-mono text-emerald-300 border border-slate-800">
            ...
            <div className="p-4 bg-slate-900/90 rounded-xl border border-slate-800 text-xs font-mono space-y-1">
              <span className="font-sans font-bold text-white block text-xs">Exemple complet avec termes négatifs :</span>
              ...
              <div className="text-emerald-400 font-bold text-sm"><MathView latex="A = 2x^2 + 5x - 12" display={false} /></div>
            </div>
          ...
          <div className="bg-rose-950/30 p-4 sm:p-5 rounded-2xl border border-rose-500/50 space-y-3">
            <div className="flex items-center space-x-2 text-rose-400 font-bold text-xs sm:text-sm uppercase tracking-wide">
            ...
            <p className="text-xs sm:text-sm text-rose-200 leading-relaxed">
              C'est la question reine des devoirs de 4e : que faire quand il y a un signe <strong className="text-white underline">« - » entre deux produits parenthésés</strong> ?
            </p>
            <div className="p-4 bg-slate-950 rounded-xl border border-rose-900 text-xs font-mono space-y-2">
              <span className="font-sans font-bold text-white block text-xs">Modèle de rédaction parfait :</span>
              <div><MathView latex="E = (3x + 1)(x - 2) - (2x - 3)(x + 4)" display={false} /></div>
              <div className="text-amber-400 font-sans text-[11px]">Règle : On met obligatoirement des crochets protecteurs après le signe « - » !</div>
              ...
              <div className="text-rose-400 font-sans text-[11px]">On supprime les crochets en inversant TOUS les signes intérieurs :</div>
              <div><MathView latex="E = 3x^2 - 5x - 2 - 2x^2 - 5x + 12" display={false} /></div>
              <div className="text-emerald-400 font-bold text-sm"><MathView latex="E = x^2 - 10x + 10" display={false} /></div>
            </div>
          </div>
        </div>
      )}
      ...
      {activeSection === 6 && (
        <div className="flex flex-col space-y-5 animate-fade-in">
          ...
          {/* Formule 1 */}
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-indigo-500/40 space-y-2.5">
            <div className="flex items-center justify-between">
              <h4 className="font-bold text-indigo-300 text-xs sm:text-sm uppercase tracking-wide">
            ...
            <div className="p-3 bg-slate-900 rounded-xl text-center font-mono text-white text-base font-bold border border-indigo-500/30">
              <MathView latex="(a + b)^2 = a^2 + 2ab + b^2" display={true} />
            </div>
            <div className="p-3 bg-slate-900/90 rounded-xl text-xs space-y-1 text-slate-300">
              <strong className="text-emerald-400 block font-bold">Le terme 2ab est le DOUBLE PRODUIT !</strong>
          ...
          {/* Formule 2 */}
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-pink-500/40 space-y-2.5">
            <div className="flex items-center justify-between">
              <h4 className="font-bold text-pink-300 text-xs sm:text-sm uppercase tracking-wide">
            ...
            <div className="p-3 bg-slate-900 rounded-xl text-center font-mono text-white text-base font-bold border border-pink-500/30">
              <MathView latex="(a - b)^2 = a^2 - 2ab + b^2" display={true} />
            </div>
            <div className="p-3 bg-slate-900/90 rounded-xl text-xs space-y-1 text-slate-300">
              <span className="text-slate-400 font-sans block text-[11px]">Remarquez : le signe - porte UNIQUEMENT sur le double produit ! Le terme <MathView latex="b^2" display={false} /> reste positif.</span>
              <div className="font-mono text-slate-300">
          ...
          {/* Formule 3 */}
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-emerald-500/40 space-y-2.5">
            <div className="flex items-center justify-between">
              <h4 className="font-bold text-emerald-300 text-xs sm:text-sm uppercase tracking-wide">
            ...
            <div className="p-3 bg-slate-900 rounded-xl text-center font-mono text-white text-base font-bold border border-emerald-500/30">
              <MathView latex="(a - b)(a + b) = a^2 - b^2" display={true} />
            </div>
            <div className="p-3 bg-slate-900/90 rounded-xl text-xs space-y-1 text-slate-300">
              <span className="text-slate-400 font-sans block text-[11px]">Ici, les deux termes du milieu s'annulent : <MathView latex="+ab - ab = 0" display={false} /> !</span>
              <div className="font-mono text-slate-300">
          ...
          <div className="bg-amber-950/30 p-4 sm:p-5 rounded-2xl border border-amber-500/40 space-y-3">
            <h4 className="font-bold text-amber-300 text-xs sm:text-sm uppercase tracking-wide flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-amber-400" />
              <span>Astuces de calcul mental instantané grâce aux identités remarquables</span>
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 text-xs font-mono text-amber-200">
              <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 space-y-1">
                <span className="font-sans font-bold text-white block">Calcul de 103² :</span>
                <div><MathView latex="103^2 = (100 + 3)^2" display={false} /></div>
                <div><MathView latex="= 100^2 + 2(100)(3) + 3^2" display={false} /></div>
                <div className="text-emerald-400 font-bold"><MathView latex="= 10000 + 600 + 9 = 10609" display={false} /></div>
              </div>
              <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 space-y-1">
                <span className="font-sans font-bold text-white block">Calcul de 98² :</span>
                <div><MathView latex="98^2 = (100 - 2)^2" display={false} /></div>
                <div><MathView latex="= 100^2 - 2(100)(2) + 2^2" display={false} /></div>
                <div className="text-emerald-400 font-bold"><MathView latex="= 10000 - 400 + 4 = 9604" display={false} /></div>
              </div>
              <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 space-y-1">
                <span className="font-sans font-bold text-white block">Calcul de 105 × 95 :</span>
                <div><MathView latex="(100 + 5)(100 - 5)" display={false} /></div>
                <div><MathView latex="= 100^2 - 5^2" display={false} /></div>
                <div className="text-emerald-400 font-bold"><MathView latex="= 10000 - 25 = 9975" display={false} /></div>
              </div>
            </div>
          </div>
        </div>
      ...
      {activeSection === 7 && (
        <div className="flex flex-col space-y-5 animate-fade-in">
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-slate-800 space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              <strong className="text-white">Factoriser</strong>, c'est transformer une somme ou une différence de termes en un <strong className="text-emerald-400">produit de facteurs</strong>. C'est l'opération inverse du développement, et c'est l'outil indispensable pour résoudre les équations du second degré.
            </p>
          </div>

          {/* Méthode 1 */}
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-sky-500/30 space-y-2.5">
            <div className="flex items-center justify-between">
              <h4 className="font-bold text-sky-400 text-xs sm:text-sm uppercase tracking-wide">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-mono">
              <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 text-sky-300">
                <div><MathView latex="15x + 25 = 5 \times 3x + 5 \times 5" display={false} /></div>
                <div className="text-white font-bold"><MathView latex="= 5(3x + 5)" display={false} /></div>
              </div>
              <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 text-sky-300">
                <div><MathView latex="6x^2 - 8x = 2x \times 3x - 2x \times 4" display={false} /></div>
                <div className="text-white font-bold"><MathView latex="= 2x(3x - 4)" display={false} /></div>
              </div>
            </div>
          </div>

          {/* Méthode 2 */}
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-amber-500/30 space-y-2.5">
            <div className="flex items-center justify-between">
              <h4 className="font-bold text-amber-400 text-xs sm:text-sm uppercase tracking-wide">
            ...
            <div className="p-3.5 bg-slate-900 rounded-xl border border-slate-800 font-mono text-xs text-amber-300 space-y-1">
              <div><MathView latex="A = (2x - 3)(x + 4) + (2x - 3)(3x - 5)" display={false} /></div>
              <div className="text-slate-400 text-[11px] font-sans">Le facteur commun est (2x - 3) :</div>
              <div><MathView latex="A = (2x - 3) [ (x + 4) + (3x - 5) ]" display={false} /></div>
              <div><MathView latex="A = (2x - 3) (x + 4 + 3x - 5)" display={false} /></div>
              <div className="text-white font-bold text-sm"><MathView latex="A = (2x - 3)(4x - 1)" display={false} /></div>
            </div>
          </div>

          {/* Méthode 3 */}
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-rose-500/30 space-y-2.5">
            <div className="flex items-center justify-between">
              <h4 className="font-bold text-rose-400 text-xs sm:text-sm uppercase tracking-wide">
            ...
            <p className="text-xs text-slate-300">
              Quand une parenthèse semble être toute seule à la fin, elle est en réalité multipliée par <strong className="text-white font-bold">1</strong> !
            </p>
            <div className="p-3.5 bg-slate-900 rounded-xl border border-slate-800 font-mono text-xs text-rose-300 space-y-1">
              <div><MathView latex="B = (x + 2)^2 + (x + 2)" display={false} /></div>
              <div className="text-slate-400 text-[11px] font-sans">On explicite le facteur 1 :</div>
              <div><MathView latex="B = (x + 2)(x + 2) + (x + 2) \times 1" display={false} /></div>
              <div><MathView latex="B = (x + 2) [ (x + 2) + 1 ]" display={false} /></div>
              <div className="text-white font-bold text-sm"><MathView latex="B = (x + 2)(x + 3)" display={false} /></div>
            </div>
          </div>
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-emerald-500/40 space-y-2.5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs font-mono">
              <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 text-emerald-300">
                <span className="font-sans font-bold text-white block text-[11px]">Cas simple :</span>
                <div><MathView latex="9x^2 - 25 = (3x)^2 - 5^2" display={false} /></div>
                <div className="text-white font-bold"><MathView latex="= (3x - 5)(3x + 5)" display={false} /></div>
              </div>
              <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 text-emerald-300">
                <span className="font-sans font-bold text-white block text-[11px]">Cas avec binôme :</span>
                <div><MathView latex="(2x + 1)^2 - 16 = (2x + 1)^2 - 4^2" display={false} /></div>
                <div><MathView latex="= [ (2x + 1) - 4 ] [ (2x + 1) + 4 ]" display={false} /></div>
                <div className="text-white font-bold"><MathView latex="= (2x - 3)(2x + 5)" display={false} /></div>
              </div>
            </div>
          </div>
      ...
      {activeSection === 8 && (
        <div className="flex flex-col space-y-5 animate-fade-in">
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-amber-500/40 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-200 leading-relaxed">
              Un produit de facteurs est nul <strong className="text-emerald-400">si et seulement si au moins l'un des facteurs est nul</strong>.
            </p>
            <div className="p-3.5 bg-slate-900 rounded-xl text-center text-sm font-mono text-amber-300 border border-slate-800">
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-slate-800 space-y-3">
            ...
            <div className="p-4 bg-slate-900 rounded-xl border border-slate-800 text-xs font-mono space-y-2">
              ...
              <div className="text-amber-400 font-sans text-[11px]">
                « Un produit de facteurs est nul si et seulement si l'un au moins de ses facteurs est nul. »
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-emerald-300 pt-1">
                <div className="p-2.5 bg-slate-950 rounded-lg border border-slate-800">
                  <div className="text-slate-400 font-sans text-[10px]">Premier facteur :</div>
                  <div><MathView latex="3x - 6 = 0" display={false} /></div>
                  <div><MathView latex="3x = 6" display={false} /></div>
                  <div className="text-white font-bold"><MathView latex="x = \frac{6}{3} = 2" display={false} /></div>
                </div>
                <div className="p-2.5 bg-slate-950 rounded-lg border border-slate-800">
                  <div className="text-slate-400 font-sans text-[10px]">Deuxième facteur :</div>
                  <div><MathView latex="2x + 8 = 0" display={false} /></div>
                  <div><MathView latex="2x = -8" display={false} /></div>
                  <div className="text-white font-bold"><MathView latex="x = \frac{-8}{2} = -4" display={false} /></div>
                </div>
              </div>
              <div className="text-emerald-400 font-sans font-bold text-xs pt-1">
      ...
      {activeSection === 9 && (
        <div className="flex flex-col space-y-5 animate-fade-in">
          ...
          <div className="bg-slate-950/80 p-4 sm:p-5 rounded-2xl border border-slate-800 space-y-3">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs text-left text-slate-300 border border-slate-800">
                <thead className="bg-slate-900 text-slate-200 font-semibold border-b border-slate-800 text-[11px]">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-800/60 font-mono text-[11px]">
                  <tr>
                    <td className="p-2.5 font-sans font-bold text-sky-400">Distributivité simple</td>
                    <td className="p-2.5 text-slate-200">k(a + b) = ka + kb</td>
                    <td className="p-2.5 text-emerald-300">4(2x - 3) = 8x - 12</td>
                  </tr>
                  <tr>
                    <td className="p-2.5 font-sans font-bold text-sky-400">Double distributivité</td>
                    <td className="p-2.5 text-slate-200">(a+b)(c+d) = ac + ad + bc + bd</td>
                    <td className="p-2.5 text-emerald-300">(x+2)(x+3) = x² + 5x + 6</td>
                  </tr>
                  <tr>
                    <td className="p-2.5 font-sans font-bold text-pink-400">Identité 1 (Somme²)</td>
                    <td className="p-2.5 text-slate-200">(a + b)² = a² + 2ab + b²</td>
                    <td className="p-2.5 text-pink-300">(2x + 3)² = 4x² + 12x + 9</td>
                  </tr>
                  <tr>
                    <td className="p-2.5 font-sans font-bold text-pink-400">Identité 2 (Différence²)</td>
                    <td className="p-2.5 text-slate-200">(a - b)² = a² - 2ab + b²</td>
                    <td className="p-2.5 text-pink-300">(3x - 1)² = 9x² - 6x + 1</td>
                  </tr>
                  <tr>
                    <td className="p-2.5 font-sans font-bold text-pink-400">Identité 3 (Différence de carrés)</td>
                    <td className="p-2.5 text-slate-200">(a - b)(a + b) = a² - b²</td>
                    <td className="p-2.5 text-pink-300">(4x - 5)(4x + 5) = 16x² - 25</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td className="p-2.5 font-sans font-bold text-emerald-400">Produit nul</td>
                    <td className="p-2.5 text-slate-200">A × B = 0 ⇔ A = 0 ou B = 0</td>
                    <td className="p-2.5 text-emerald-300">(x-4)(2x+6)=0 ⇔ x=4 ou x=-3</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="bg-indigo-950/30 p-4 sm:p-5 rounded-2xl border border-indigo-500/40 space-y-3">
            <div className="flex items-center space-x-2 text-indigo-300 font-bold text-xs sm:text-sm uppercase tracking-wide">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              ...
              <strong className="text-white"> remplacez x par un petit nombre (comme 1 ou 2)</strong> dans l'expression initiale et dans votre résultat développé. Si vous trouvez exactement le même nombre, votre calcul est exact !
            </p>

            {/* Mini Simulateur de vérification interactif */}
            <div className="p-4 bg-slate-900 rounded-xl border border-slate-800 space-y-3">
              <span className="font-bold text-white text-xs block">Testez cette astuce en direct :</span>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                <div>
                  <label className="text-[11px] text-slate-400 block mb-1">Expression initiale :</label>
                  <input
                    type="text"
                    value={testExprInit}
                    onChange={(e) => setTestExprInit(e.target.value)}
                    className="w-full bg-slate-950 border border-slate-700 rounded-lg p-2 text-emerald-300 font-mono text-xs"
                  />
                </div>
                <div>
                  <label className="text-[11px] text-slate-400 block mb-1">Votre développement :</label>
                  <input
                    type="text"
                    value={testExprDev}
                ...
                <div>
                  <label className="text-[11px] text-slate-400 block mb-1">Valeur de test (x) :</label>
                  <input
                    type="number"
                    value={testValueX}
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between p-3 rounded-xl bg-slate-950 border border-slate-800 text-xs font-mono">
                <div className="space-y-0.5">
                  <div>Valeur initiale pour x={testValueX} : <span className="text-emerald-400 font-bold">{valInit !== null ? valInit : 'Erreur'}</span></div>
                  <div>Valeur développée pour x={testValueX} : <span className="text-indigo-400 font-bold">{valDev !== null ? valDev : 'Erreur'}</span></div>
                </div>

                <div className="mt-2 sm:mt-0">
                  {isMatch ? (
                    <span className="px-3 py-1.5 rounded-lg bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 flex items-center space-x-1.5 font-bold font-sans">
                      <Check className="w-4 h-4 text-emerald-400" />
                      <span>Parfait : Calcul 100% Validé !</span>
                    </span>
                  ) : (
                    <span className="px-3 py-1.5 rounded-lg bg-rose-500/20 text-rose-300 border border-rose-500/40 flex items-center space-x-1.5 font-bold font-sans">
          ...
          <div className="bg-rose-950/30 p-4 sm:p-5 rounded-2xl border border-rose-500/40 space-y-3">
            <h4 className="font-bold text-rose-300 text-xs sm:text-sm uppercase tracking-wide flex items-center gap-2">
              <ShieldAlert className="w-5 h-5 text-rose-400" />
              <span>Les 5 erreurs mortelles qui coûtent 10 points en devoir</span>
            </h4>
            <ul className="list-disc list-inside text-xs text-rose-200 space-y-2 pl-1">
              <li>
                <strong className="text-white">Oubli du double produit :</strong> Écrire <MathView latex="(x + 3)^2 = x^2 + 9" display={false} /> au lieu de <MathView latex="x^2 + 6x + 9" display={false} />.
              </li>
              <li>
                <strong className="text-white">Oubli du crochet protecteur après le signe moins :</strong> Dans <MathView latex="A - (B \times C)" display={false} />, développer sans crochets et ne changer que le premier signe.
              </li>
              <li>
                <strong className="text-white">Mélange des opérations :</strong> Confondre <MathView latex="x + x = 2x" display={false} /> et <MathView latex="x \times x = x^2" display={false} />.
              </li>
              <li>
                <strong className="text-white">Addition de familles différentes :</strong> Écrire <MathView latex="3x + 4 = 7x" display={false} /> ou <MathView latex="2x^2 + 3x = 5x^3" display={false} />.
              </li>
              <li>
                <strong className="text-white">Parenthèses manquantes au carré d'un monôme :</strong> Écrire <MathView latex="(3x)^2 = 3x^2" display={false} /> au lieu de <MathView latex="9x^2" display={false} />.
              </li>
            </ul>
          </div>
        </div>
