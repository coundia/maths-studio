...
export async function computeExpressionHash(operationType: string, normalizedExpr: string): Promise<string> {
...
export async function solveByHeuristic(rawExpr: string, normalizedExpr: string, operationType: string): Promise<ExpressionSolution | null> {
